...
public class DiscontinuousRangeMap<O extends MutableObject, K extends Comparable<K>, R extends DoubleKeyedChildEntity<O, K> & HasDuration<K>> extends TreeMap<K, R> {
